      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 9}>
            ...
            <div className=" ">
              <div className="mt-0 flex flex-col gap-4 md:flex-row" style={{ opacity: 1, transform: "none" }}>

                <div className="flex flex-wrap gap-2"><div className="mt-4 size-6 hover:cursor-pointer" data-state="closed" data-slot="tooltip-trigger">
                  <svg viewBox="0 0 128 128"><g fill="#61DAFB">
